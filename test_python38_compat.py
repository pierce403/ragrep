#!/usr/bin/env python3
"""Test Python 3.8 compatibility specifically."""
...
def test_python38_imports():
    """Test imports with Python 3.8 syntax."""
    print("🔍 Testing Python 3.8 imports...")
...
def test_python38_chromadb():
    """Test ChromaDB with Python 3.8 compatibility."""
    print("\n🔍 Testing ChromaDB Python 3.8 compatibility...")
    ...
    try:
        ...
        vector_store = VectorStore("./test_python38_db")
...
def test_python38_cli():
    """Test CLI with Python 3.8 compatibility."""
    print("\n🔍 Testing CLI Python 3.8 compatibility...")
...
def main():
    """Run Python 3.8 compatibility tests."""
    ...
    # Run tests
    tests = [
        ("Python 3.8 Imports", test_python38_imports),
        ("ChromaDB Compatibility", test_python38_chromadb),
        ("CLI Compatibility", test_python38_cli),
    ]
    ...
    if passed == len(tests):
        print("\n🎉 All Python 3.8 compatibility tests passed!")
        return 0
    else:
        print("\n⚠️  Some Python 3.8 compatibility tests failed!")
        return 1
